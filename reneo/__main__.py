...
def run_options(func):
    ...
    options = [
        ...
        click.option(
            ...
            default=0.25,
            required=False,
            help="case 1 linear clustering distance threshold",
            type=float,
            show_default=True,
        ),
        click.option(
            ...
            default=0.25,
            required=False,
            help="case 1 linear clustering coverage weight",
            type=float,
            show_default=True,
        ),
        click.option(
            ...
            default=100,
            required=False,
            help="number of Ns between clustered case 1 linear segments",
            type=int,
            show_default=True,
        ),
        click.option(
